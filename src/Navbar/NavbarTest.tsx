    ...
    <div className="relative bg-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 pb-8 bg-slate-900 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <Popover>
            ...
            >
              ...
              >
                <div className="rounded-lg shadow-md bg-slate-400 ring-1 ring-black ring-opacity-5 overflow-hidden">
                  ...
                  <a
                    href="#"
                    className="block w-full px-5 py-3 text-center font-medium text-indigo-600 bg-gray-800 hover:bg-gray-100"
                  >
                    Log in
                  </a>
                </div>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          src="https://www.aliciagalvan.com/wp-content/uploads/2019/05/su_signo_segun_el_horoscopo_maya_1_joya_life-1600x400.jpg"
          alt=""
        />
      </div>
    </div>
